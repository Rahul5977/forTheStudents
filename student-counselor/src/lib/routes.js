...
export const ALL_SCREENS = [
  ...
  'dashboard', 'profile', 'predictor', 'filters', 'collegeDetail', 'collegeExplorer', 'compare', 'shortlist', 'choiceBuilder', 'choiceExport', 'marketplace', 'mentorProfile', 'booking', 'payment', 'bookingConfirm', 'sessions', 'sessionRoom', 'rateSession', 'timeline', 'notifications', 'help', 'settings', 'receipts',
